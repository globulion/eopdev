...
\end{figure}
%
All the models that are linear with respect to the electric field incorrectly predict the polarization energy.
...
see also red filled dots in Figure~\ref{f:fig-1}).
