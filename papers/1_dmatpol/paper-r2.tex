...
of electron density distribution when the electric fields are highly non\hyp{}uniform in space.
Due to all of these reasons, we adopt the following approach: 
we first develop a qualitative first\hyp{}principles distributed site model at the Hartree\hyp{}Fock (HF)
...
electrostatic perturbations due to randomly selected uniform electric fields and random collections of point charges
...
\caption{\label{f:fig-1} A figure caption. The figure captions are
