...
I appreciate the positive and constructive feedbacks given, and agree with the reviewers’ 
...
dimer would much increase the quality of the present manuscript. Unfortunately, as the Reviewer also
understands, this requires a separate article since other effects such as Pauli exchange-repulsion
need to be included and combined with polarization in order to compare to the full HF result. 
Due to this reason, I decided to write a separate manuscript on that issue in the future.
\end{reply}
...
\begin{reply}
I agree with the remark, thanks. I changed the sentence to incorporate this:
\begin{quote}
