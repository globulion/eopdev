...
was implemented in our in\hyp{}house plugin to {\sc Psi4} quantum chemistry program.
Water molecule, energy\hyp{}optimized by using the HF/6-311++G** method, 
...
tensor description of the spatial polarization of the electron density distribution.
