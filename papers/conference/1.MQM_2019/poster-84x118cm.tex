...
\begin{textblock*}{249mm}(10mm,261mm)
...
\vskip0.9ex
\caption{\bf Application of the OEP technique to significantly simplify original theory of Murrell et al. [5] (left). 
             Fragment parameters are shown in blue.}
\end{figure}
\end{exampleblock}
\end{textblock*}
