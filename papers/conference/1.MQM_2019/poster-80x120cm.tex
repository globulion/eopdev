...
\begin{block}{CT energy by Murrell et al.}
  \vskip-2ex
  \begin{equation*}
...
%
%% --------------------- REFERENCES
%\begin{textblock*}{440mm}(10mm,1106mm)
%\begin{exampleblock}{\color{blue} References}
%    References\\
%    \begin{small}
%[1] Gordon, M. S.; Fedorov. D. G.; Pruitt, S. R.; Slipchenko L. V.; Chem. Rev., 2012, 112, 632
%[2] Murrell, J. N.; Randic, M.; Williams O. R.; Proc. Roy. Soc. A, 1965, 284, 566
%[3] Li, H.; Gordon, M. S.; J. Chem. Phys., 2006, 124, 214108
%              [2] B. B{\l}asiak, M. Maj, R. W. G{\'o}ra, M. Cho, \newline\emph{J. Chem. Theory Comput.}, 11, 3259 {\bf{\small 2015}};
%    \end{small}         
%%\end{exampleblock}
%\end{textblock*}
%
