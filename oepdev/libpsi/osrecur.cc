...
ObaraSaikaTwoCenterMultipolePotentialRecursion::ObaraSaikaTwoCenterMultipolePotentialRecursion(int max_am1, int max_am2,
                                                                                               int max_k)
...
void ObaraSaikaTwoCenterMultipolePotentialRecursion::calculate_f(double *F, int n, double t) {
    int i, m;
    int m2;
    double t2;
    double num;
...
void ObaraSaikaTwoCenterMultipolePotentialRecursion::compute(double PA[3], double PB[3], double PC[3], double zeta,
                                                             int am1, int am2) {
    int a, b, m;
    int azm = 1;
    int aym = am1 + 1;
                ...
                if (bz > 0) {
                    ...
                    if (do_dipole)
                        for (m = 0; m <= mmax - b - 1; ++m) { /* Electric field integrals */
                            ...
                            z_[0][bind][m] = PB[2] * z_[0][bind - bzm][m] - PC[2] * z_[0][bind - bzm][m + 1] +
                                             q_[0][bind - bzm][m + 1];
                        }
                    if (do_quadrupole)
                    ...
                    if (do_dipole)
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            ...
                            y_[0][bind][m] = PB[1] * y_[0][bind - bym][m] - PC[1] * y_[0][bind - bym][m + 1] +
                                             q_[0][bind - bym][m + 1];
                    ...
                    if (do_dipole)
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            x_[0][bind][m] = PB[0] * x_[0][bind - bxm][m] - PC[0] * x_[0][bind - bxm][m + 1] +
                                             q_[0][bind - bxm][m + 1];
