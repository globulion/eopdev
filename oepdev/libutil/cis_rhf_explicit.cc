...
R_CISComputer_Explicit::R_CISComputer_Explicit(std::shared_ptr<psi::Wavefunction> wfn, psi::Options& opt):
 R_CISComputer(wfn, opt)
{
}

R_CISComputer_Explicit::~R_CISComputer_Explicit() {}

void R_CISComputer_Explicit::set_beta_(void) {
 //Fb_oo_ = Fa_oo_;
 //Fb_vv_ = Fa_vv_;
 eps_b_o_ = eps_a_o_;
 eps_b_v_ = eps_a_v_;
...
void R_CISComputer_Explicit::build_hamiltonian_(void) {
