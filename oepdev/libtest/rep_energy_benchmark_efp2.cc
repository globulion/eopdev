...
double oepdev::test::Test::test_rep_energy_benchmark_efp2(void)
{
  // Reference data for H2O dimer 6-311++G** 6D
  const double ref_e = +0.00827678; // Total Exchange-Repulsion Energy [A.U.]
  ...
  double e = solver->compute_benchmark("EFP2"); 
