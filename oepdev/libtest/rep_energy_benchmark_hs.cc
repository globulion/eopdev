...
double oepdev::test::Test::test_rep_energy_benchmark_hs(void)
{
  // Reference data for H2O dimer 6-311++G** 6D
  const double ref_e = +0.00892274; // Total Exchange-Repulsion Energy [A.U.]
  ...
  double e = solver->compute_benchmark("HAYES_STONE"); 
