 ...
 *  <tr><td> `EET V0 TI-CIS CM-1`  <td> Approximate total coupling (cm-1)
 *  <tr><td> `EET V TI-CIS CM-1`  <td> Total coupling (cm-1)
 *  <tr><td> `EET V0 EXCH-M CM-1` <td> Overlap-uncorrected exchange (Dexter) coupling in Mulliken approximation (cm-1)
 *  <tr><td> `EET V EXCH-M CM-1` <td> Overlap-corrected exchange (Dexter) coupling in Mulliken approximation (cm-1)
 *  <tr><td> `EET V0 CT-M CM-1`  <td> Overlap-uncorrected H_34 matrix element in Mulliken approximation (cm-1)
 ...
 *  <tr><td> `EET V0 OEP:HT1 CM-1`       <td> Overlap-uncorrected H_14 matrix element (cm-1)
 *  <tr><td> `EET V0 OEP:HT2 CM-1`       <td> Overlap-uncorrected H_23 matrix element (cm-1)
 *  <tr><td> `EET V0 OEP:CT:CAMM CM-1`   <td> Overlap-uncorrected H_34 matrix element: CAMM approximation of ionic interaction (cm-1)
 *  <tr><td> `EET V0 OEP:CT:CC CM-1`     <td> Overlap-uncorrected H_34 matrix element: Point-charge approximation of ionic interaction (cm-1)
 *  <tr><td> `EET V OEP:ET1 CM-1`        <td> Overlap-corrected H_13 matrix element (cm-1)
 *  <tr><td> `EET V OEP:ET2 CM-1`        <td> Overlap-corrected H_24 matrix element (cm-1)
 *  <tr><td> `EET V OEP:HT1 CM-1`        <td> Overlap-corrected H_14 matrix element (cm-1)
 *  <tr><td> `EET V OEP:HT2 CM-1`        <td> Overlap-corrected H_23 matrix element (cm-1)
 *  <tr><td> `EET V OEP:CT:CAMM CM-1`    <td> Overlap-corrected H_34 matrix element: CAMM approximation of ionic interaction (cm-1)
 *  <tr><td> `EET V OEP:CT:CC CM-1`      <td> Overlap-corrected H_34 matrix element: Point-charge approximation of ionic interaction (cm-1)
 *  <tr><td> `EET V OEP:TI-2 CM-1`      <td> 2nd-order indirect coupling (cm-1)
 *  <tr><td> `EET V OEP:TI-3:CAMM CM-1` <td> 3rd-order indirect coupling with CAMM approximation for V_CT (cm-1)
 *  <tr><td> `EET V OEP:TI-3:CC CM-1`   <td> 3rd-order indirect coupling with point-charge approximation for V_CT (cm-1)
 *  <tr><td> `EET V OEP:DIRECT CM-1`     <td> Direct coupling (cm-1)
 *  <tr><td> `EET V OEP:INDIRECT:CAMM CM-1` <td> Indirect coupling with CAMM approximation for V_CT (cm-1)
 *  <tr><td> `EET V OEP:INDIRECT:CC CM-1`   <td> Indirect coupling with point-charge approximation for V_CT (cm-1)
 *  <tr><td> `EET V OEP:TI-CIS:CAMM CM-1`   <td> Total coupling with CAMM approximation for V_CT (cm-1)
 *  <tr><td> `EET V OEP:TI-CIS:CC CM-1`     <td> Total coupling with point-charge approximation for V_CT (cm-1)
 * </table>
 */
