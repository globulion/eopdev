 ...
 *  <tr><td> `EET V OEP:TI_CIS:CAMM CM-1`   <td> Total coupling with CAMM approximation for V_CT (cm-1)
 *  <tr><td> `EET V OEP:TI_CIS:CC CM-1`     <td> Total coupling with point-charge approximation for V_CT (cm-1)
 * </table>
 */
