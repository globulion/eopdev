...
#gefp.math.matrix.move_atom_rotate_molecule(dimer, [-.2, 23.0, -40.4])
dimer.print_cluster()
...
psi4.set_options({"scf_type"                : "df"                 ,             
                  ...
                  "dmtp_conver_ti_cis_e34"  : "R5"                 ,
                  "dmtp_conver_ti_cis_ct"   : "R5"                 ,
                  "oepdev_df_type"          : "single"             ,
                  "trcamm_symmetrize"       : True                 , 
                  "ti_cis_scf_fock_matrix"  : True                 , 
...
solver.compute_oep_based("FUJIMOTO_TI_CIS")
